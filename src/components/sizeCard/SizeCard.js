...
const SizeCard = ({ size, sizeAndQuantity, setSizeAndQuantity, handleFormChange }) => {
    ...
    return (
        <div>
            {/* <div className='flex justify-between items-center border m-2 p-2 rounded animate__animated animate__fadeInDown'>
                ...
                <input onChange={(e) => handleFormChange(event, index)} placeholder='0' className='border w-[70%] rounded-r p-2' type="number" />
